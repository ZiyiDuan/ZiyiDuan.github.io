...
How do we form internal thought and turn that into an action? I aim to understand how the brain brings about these abilities. My work focuses on two fundamental cognitive processes: **representations** and **transformations**. Specifically, I study **working memory**, examining how this mental workspace dynamically transforms information to serve a specific task goal — a process that spans from initial **sensory processing** to sustained **mnemonic coding**, and finally to the **motor planning** of future actions. I tackle this using a set of tools, including neuroimaging approaches (fMRI/EEG), psychophysics, eye-tracking, motion capture system, machine learning, and computational modeling. Here are the **[research projects](/research)** I've been working on.
