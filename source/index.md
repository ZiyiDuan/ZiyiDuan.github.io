...
How do we generate internal thoughts and turn them into action? I am interested in understanding the cognitive and neural basis of internal representations and intentions. My research focuses on **working memory**, examining how this mental workspace dynamically transforms information to serve a specific task goal — a process that spans from initial **sensory processing** to sustained **mnemonic coding**, and finally to the **motor planning** of future actions. I tackle this using a set of tools, including neuroimaging (fMRI/EEG), machine learning, psychophysics, eye-tracking, motion-capture systems, and computational modeling. Here are the **[research projects](/research)** I've been working on.
